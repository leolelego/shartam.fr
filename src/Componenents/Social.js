...
function Social(props) {
    return (
        <div className="social">
            ...
            {/* <a href="https://www.messenger.com/t/shartam.atelier" target="_blank" rel="noopener noreferrer"><img src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Facebook_Messenger_logo.svg" style={{height: 48}} alt="Messenger"/></a> */}
